...
<body>
	...
	require('Protect.php');
	session_start();
	$id=mysqli_real_escape_string($conn,test_input($_POST['user']));
    $pwd=mysqli_real_escape_string($conn,	test_input($_POST['pass']));
	$tp=test_input($_POST['type']);
    if($tp=='ins')
    {	$_SESSION['id']=$id;
		$_SESSION['pwd']=$pwd;
		...
		<div class="container-login100">
			<div class="wrap-login100">
				<form class="login100-form validate-form p-l-55 p-r-55 p-t-178" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
					...
					<div class="flex-col-c p-t-30 p-b-30">
